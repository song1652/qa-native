...
def test_links_not_found_api(page):
    ...
    # Click "Not Found" API call link
    not_found_link = page.locator("#invalid-url")
    expect(not_found_link).to_be_visible(timeout=10000)
    ...
    expect(link_response).to_contain_text("404", timeout=10000)
    expect(link_response).to_contain_text("Not Found", timeout=10000)
