...
def test_links_created_api(page):
    ...
    # Click "Created" API call link
    created_link = page.locator("#created")
    expect(created_link).to_be_visible(timeout=10000)
    created_link.click()
    ...
    expect(link_response).to_contain_text("201", timeout=10000)
    expect(link_response).to_contain_text("Created", timeout=10000)
