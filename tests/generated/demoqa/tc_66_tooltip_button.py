...
def test_tooltip_button_hover(page: Page):
    ...
    hover_button = page.locator("#toolTipButton")
    expect(hover_button).to_be_visible(timeout=10000)
    hover_button.hover()
    ...
    expect(tooltip).to_contain_text("You hovered over the Button", timeout=5000)
