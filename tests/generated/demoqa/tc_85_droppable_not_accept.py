"""Playwright 테스트 — test_droppable_not_accept (tc_85)"""
...
def test_droppable_not_accept(page):
    """Droppable not accept - not acceptable element stays"""
    ...
    # "Not Acceptable" box has no ID, it's the second .drag-box
    source = page.locator("#acceptDropContainer .drag-box:has-text('Not Acceptable')")
    ...
    expect(target).to_contain_text("Drop here", timeout=5000)
